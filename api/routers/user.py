...
async def register_user(user: UserCreate, service=Depends(get_service(UserService))):
...
async def get_user(id, service=Depends(get_service(UserService)), current_user=Depends(get_current_user)):
...
async def login(user: UserLogin, service=Depends(get_service(UserService))):
